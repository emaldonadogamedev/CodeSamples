  ...
  m_meshFile(meshFile)
{
  ...
  m_phongMaterial->Ka = XMFLOAT4(0.25f, 0.20725f, 0.20725f, 1.0f);
  m_phongMaterial->Kd = XMFLOAT4(1.0f, 0.829f, 0.829f, 1.0f);
  m_phongMaterial->Ks = XMFLOAT4(0.296648f, 0.296648f, 0.296648f, 1.0f);
