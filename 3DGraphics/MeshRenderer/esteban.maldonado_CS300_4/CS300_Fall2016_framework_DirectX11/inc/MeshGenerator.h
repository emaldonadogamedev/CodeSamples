...
public:
  ...
  //Basic Shapes
  static MeshBuffer CreateBox(MeshData& meshData, std::string name = BOX_MESH, float width = 1.0f, float height = 1.0f, float depth = 1.0f, XMFLOAT4 color = XMFLOAT4(1, 1, 1, 1));
