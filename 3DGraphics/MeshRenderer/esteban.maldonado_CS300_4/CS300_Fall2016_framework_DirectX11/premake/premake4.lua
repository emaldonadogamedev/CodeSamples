...
local assignmentTitle = "Assignment4"

if _ACTION == "clean" then
  os.rmdir("../bin")
  os.rmdir("./projects")
  os.rmdir("./ipch")
  os.remove("CS300_DX11.sln")
  os.remove("CS300_DX11.sdf")
  os.remove("CS300_DX11.suo")
  os.remove("CS300_DX11.v11.suo")
  os.remove("CS300_DX11.v12.suo")
  os.exit()
end
